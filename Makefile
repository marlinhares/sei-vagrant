...
build-containers: clean
	...
	docker tag  sei3_jod-2.2.2 processoeletronico/vagrant-sei4_jod:latest
	docker tag  sei3_jod-2.2.2 processoeletronico/vagrant-sei4_jod:$(VERSAO_CONTAINERS)
	...
	docker tag sei3_httpd-2.4 processoeletronico/vagrant-sei4_httpd:$(VERSAO_CONTAINERS)

	docker build -t sei3_mailcatcher mailcatcher
	docker tag sei3_mailcatcher processoeletronico/vagrant-sei4_mailcatcher:latest
	docker tag sei3_mailcatcher processoeletronico/vagrant-sei4_mailcatcher:$(VERSAO_CONTAINERS)

	docker build -t sei3_memcached memcached
	docker tag sei3_memcached  processoeletronico/vagrant-sei4_memcached:latest
	docker tag sei3_memcached  processoeletronico/vagrant-sei4_memcached:$(VERSAO_CONTAINERS)

	docker build -t sei3_sqlserver-2017 sqlserver
	docker tag sei3_sqlserver-2017 processoeletronico/vagrant-sei4_sqlserver:latest
	docker tag sei3_sqlserver-2017 processoeletronico/vagrant-sei4_sqlserver:$(VERSAO_CONTAINERS)
